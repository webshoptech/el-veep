                ...
                <div className="mb-8">
                    ...
                    <form onSubmit={handleSearch} className="flex mt-5 gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="cursor-pointer px-6 py-2 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:bg-green-300 disabled:cursor-not-allowed transition"
                        >
