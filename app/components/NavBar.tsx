      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 h-14">
        ...
        <Menu as="div" className="relative">
          <MenuButton className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg text-sm font-bold transition-all border border-white/5">
            ...
            <span className="hidden lg:block uppercase tracking-wider">
              Browse Categories
            </span>
          ...
          >
            <MenuItems className="absolute left-0 mt-3 w-64 bg-white text-gray-800 shadow-2xl rounded-xl z-[70] py-2 border border-gray-100 overflow-hidden">
              ...
              <Link
                href="/categories"
                className="flex items-center justify-between px-4 py-3 text-sm font-semibold text-green-700 bg-green-50 hover:bg-green-100 transition"
              >
        ...
        <div className="md:hidden">
          <Link
            href="https://wa.me/2347078849739?text=I%20would%20like%20to%20make%20an%20order%20item%20from%20your%20website"
            target="_blank"
            className="flex items-center gap-2 text-xs font-bold bg-green-500 text-white px-3 py-1.5 rounded-full animate-pulse shadow-lg"
          >
