...
const ContactForm: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-xl shadow-2xl border border-gray-100">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Send Us a Message</h3>

            {/* Status Messages */}
            {status === 'success' && (
                <div className="bg-green-100 text-green-700 p-3 rounded-lg border border-green-300">
            ...
            {status === 'error' && (
                <div className="bg-red-100 text-red-700 p-3 rounded-lg border border-red-300">
                    Error submitting form: {error || "Please try again later."}
                </div>
            )}
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-1 space-y-8 p-6 lg:p-0">
                        ...
                        {/* Map Placeholder */}
                        <div className="bg-white p-6 rounded-xl shadow-md h-64 flex items-center justify-center text-gray-400 border border-gray-100">
